...
<main class="studio-main">
  <header class="studio-header">
    ...
    <div class="header-actions">
      ...
      <button class="btn btn-primary" disabled={!draft || isSaving || draft?.status === 'published'} onclick={publish}>{draft?.status === 'published' ? 'Published' : 'Publish'}</button>
    </div>
  </header>
