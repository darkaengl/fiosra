        ...
        {#if selectedConcept}
          {#if selectedConcept.concept_type === 'misconception'}
            <div class="inspector-heading">
              <div>
                <span class="eyebrow" style="color: #d89a3a;">⚠️ Pedagogical Cognitive Trap</span>
                <h3>{selectedConcept.label}</h3>
              </div>
              <span class="level-pill" style="background: rgba(216, 154, 58,0.18); color: #d89a3a; border-color: rgba(216, 154, 58,0.4);">Misconception</span>
            </div>
            <p class="definition">{selectedConcept.definition}</p>
            {#if selectedConcept.remediation_hint}
              <div class="relationship-card" style="border-color: rgba(216, 154, 58,0.3); background: rgba(216, 154, 58,0.06);">
                <h4 style="color: #d89a3a;">Remediation Socratic Guidance</h4>
...
<style>
  ...
  .model-pill { align-self: flex-start; background: rgba(15,23,42,.55); border: 1px solid rgba(147,197,253,.25); border-radius: 99px; color: #bfdbfe; font-family: var(--fio-font-mono); font-size: 9px; padding: 5px 7px; white-space: nowrap; }
  ...
  .proposal-concept { background: rgba(15,23,42,.7); border: 1px solid rgba(148,163,184,.16); border-radius: var(--fio-radius-sm); padding: 10px; }
